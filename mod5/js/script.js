...
(function (global) {
  ...
  function buildAndShowAboutHTML(aboutHtml) {
    ...
    for (var i = 1; i <= 5; i++) {
      var className = "fa fa-star-o"; // Default to empty star
      // If the current star index is less than or equal to random rating fill it
      if (i <= randomRating) {
        className = "fa fa-star";
      }
      // Substitute {{classX}} with class name
      aboutHtml = insertProperty(aboutHtml, "class" + i, className);
    }

    // Substitute {{rating}} with the text
